...
public class Camera2BasicFragment extends Fragment
    ...
    private void setUpCameraOutputs(int width, int height, int facingId) {//CameraCharacteristics.LENS_FACING_FRONT
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                }//~https://stackoverflow.com/questions/33127258/front-camera-in-camera2-not-capturing-image/40597153#40597153
    ...
    private void takePicture() {
        if (mAutoFocusSupported) {//mAutoFocusSupported 지원 안되면
            lockFocus();
        }
        else{
            captureStillPicture();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.picture:
                ...
                break;
            case R.id.change:
                if(facingId == CameraCharacteristics.LENS_FACING_FRONT){//전면카메라일때
